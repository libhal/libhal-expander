...
class libhal_expander_conan(ConanFile):
    name = "libhal-expander"
    license = "Apache-2.0"
    homepage = "https://github.com/libhal/libhal-expander"
    description = ("A collection of drivers for the expander")
