 ...
 *    hal::expander::pca9685 pca9685(i2c, address);
...
public:
   ...
   *
   * This allows the user to only retrieve the frequency, and update duty cycle for any channel.
   */
   ...
   * NOTE: Prefer PWM16_channel version instead of this one as it will soon be deprecated.
   *
